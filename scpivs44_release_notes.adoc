...
Pour plus d'informations, voir https://library.netapp.com/ecm/ecm_download_file/ECMLP2885659["Notes de version du plug-in SnapCenter pour VMware vSphere 4.8"^]
