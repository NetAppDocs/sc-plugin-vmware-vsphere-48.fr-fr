...
+
** Pour créer un groupe de ressources pour une machine virtuelle, cliquez sur *Menu* > *hôtes et clusters*, puis cliquez avec le bouton droit de la souris sur une machine virtuelle, puis sélectionnez NetApp SnapCenter, puis cliquez sur image:scpivs44_image6.png["Erreur : image graphique manquante"] *Créer un groupe de ressources*.
